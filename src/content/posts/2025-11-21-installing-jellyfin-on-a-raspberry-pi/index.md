...
image: "./cover.jpg"
tags: [Raspberry Pi, Jellyfin, Docker, Self-hosted, Transmission]
---
...
![Raspberry Pi menu highlighting Control Centre](./rpi_jellyfin_01.png)

In **Interfaces**, toggle SSH on as shown below—this is how you'll manage the
server remotely:

![Control Centre Interfaces tab with SSH enabled](./rpi_jellyfin_02.png)
...
![Control Centre System tab with Boot set to CLI](./rpi_jellyfin_03.png)

Close Control Centre, click the network icon in the panel, and choose **Advanced
Options → Edit Connections…** as shown here:

![Panel network menu highlighting Edit Connections](./rpi_jellyfin_04.png)
...
![Network Connections window with Ethernet profile](./rpi_jellyfin_05.png)
