...
description: "Creating WEBP files on Linux with GIMP"
tags: [GIMP,webp,image,sticker,Linux]
category: Linux
draft: false
---
...
this tutorial is to use create this sticker from a photo: 

![](./my_gimp_sticker.webp)
